...
from b_DQN.dqn_cartpole import Qnet, ReplayMemory
    ...
    for i in range(num_episodes):
        ...
        while True:
            ...
            if memory.size() > 2000 and total_step_idx % train_step_interval == 0:
                ...
                # target과 q_a의 차이(차이가 커질수록 훈련이 더 필요하다는 것을 뜻함)
                # 왜냐하면 target이 q_a에 점점 다가가야지 정답이기 때문에
                ...
                wandb.log({
                    ...
                    "EPSILON": epsilon,
                    "TRAINING_STEPS": training_time_steps,
        ...
        if i % print_episode_interval == 0 and i != 0:
            print("EPISODE: {0:3d}, EPISODE_REWARD: {1:5.1f}, "
                ...
                i, episode_reward, memory.size(), epsilon, training_time_steps
            ))
