...
from b_DQN.dqn_atari_train_and_model_save import AtariCNN
...
def main_q_play(num_episodes):
    ...
    model_params = torch.load(
        os.path.join(MODEL_DIR, "dqn_PongNoFrameskip-v4_3.7_0.5.pth")
        # "dqn_PongNoFrameskip-v4_19.7_0.9.pth 이부분 바껴야돼
    )
