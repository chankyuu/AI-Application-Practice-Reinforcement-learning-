...
class TicTacToe:
    def __init__(self):
        ...
        # ALL_STATES는 사전! {키 값에 대한 해쉬값 : 해당하는 값} 으로 들어감
...
# dummy_agent는 학습을 안 하고 항상 랜덤으로 뽑는거임
class Dummy_Agent:
    ...
    def get_action(self, state):
        ...
        # e.g., available_action_ids = [2, 3, 5, 6, 7] 이면 여기서 랜덤으로 고름
